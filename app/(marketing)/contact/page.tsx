    ...
    <>
      ...
      <DoodleBg className="flex-1">
        <main>
          ...
          <div className="mt-8 rounded-2xl border border-border bg-card p-6 space-y-3 text-zb-cream/90">
            <p className="flex items-start gap-3">
              <MapPin className="mt-0.5 size-5 shrink-0 text-zb-bone" />
              <span>San Julio Subdivision, Nangka St, Barangay 2, San Carlos City</span>
            </p>
            ...
            <p className="flex items-center gap-3">
              ...
              <a className="hover:text-zb-cream" href="tel:+639186056360">0918 605 6360</a>
            </p>
            <p className="flex items-center gap-3">
              <MessageCircle className="size-5 shrink-0 text-zb-bone" />
