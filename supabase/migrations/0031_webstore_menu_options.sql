-- Carry reusable Menu Studio options through webstore checkout and orders.
...
create policy "staff read order item options"
...
begin
  ...
  for v_line in select * from jsonb_array_elements(v_lines) loop
    ...
    -- Enforce each linked group's current selection rules.
    for v_group in
